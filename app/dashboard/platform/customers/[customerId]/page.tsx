...
import {
    CustomerKpiGrid,
} from "@/components/dashboard/platform/customers/detail/CustomerKpiGrid";

import {
    CustomerIdentityCard,
} from "@/components/dashboard/platform/customers/detail/CustomerIdentityCard";

import {
    CustomerWalletCard,
} from "@/components/dashboard/platform/customers/detail/CustomerWalletCard";

import {
    CustomerSmartAccountCard,
} from "@/components/dashboard/platform/customers/detail/CustomerSmartAccountCard";

import {
    CustomerSubscriptionSummary,
} from "@/components/dashboard/platform/customers/detail/CustomerSubscriptionSummary";

import {
    CustomerBillingSummary,
} from "@/components/dashboard/platform/customers/detail/CustomerBillingSummary";

import {
    CustomerPermissionSummary,
} from "@/components/dashboard/platform/customers/detail/CustomerPermissionSummary";

import {
    CustomerTransactions,
} from "@/components/dashboard/platform/customers/detail/CustomerTransactions";

import {
    CustomerActivity,
} from "@/components/dashboard/platform/customers/detail/CustomerActivity";

import {
    CustomerMetadata,
} from "@/components/dashboard/platform/customers/detail/CustomerMetadata";
