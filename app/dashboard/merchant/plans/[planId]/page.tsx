...
export default function BillingPlanPage() {
  ...
  useEffect(() => {
    ...
    getTokenMetadata(plan.payment_token as `0x${string}`)
      .then(setTokenInfo)
      .catch(console.error);
  }, [plan]);
  ...
  if (loading) {
    return (
      <main className="mx-auto flex max-w-7xl justify-center p-10">
        <p className="text-slate-400">Loading billing plan...</p>
      </main>
    );
  }
  ...
  if (!plan) {
    return (
      <main className="mx-auto flex max-w-7xl justify-center p-10">
        <p className="text-red-400">Billing plan not found.</p>
      </main>
    );
  }
    ...
    <main className="mx-auto max-w-7xl space-y-8 p-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-slate-400">Billing Plan #{plan.plan_id}</p>
        </div>
      ...
      <section className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
          <p className="text-sm text-slate-400">Billing Interval</p>
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
          <p className="text-sm text-slate-400">Payment Token</p>
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
          <p className="text-sm text-slate-400">Maximum Subscribers</p>
      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900 p-6">
        <h2 className="text-lg font-semibold text-white">Plan Actions</h2>
        ...
        <div className="flex justify-between">
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <button
              ...
              onClick={async () => {
                await modifyPlan("pausePlan", 1, "pause", plan);
            ...
            <button
              ...
              onClick={async () => {
                await modifyPlan("archivePlan", 2, "archive", plan);
            ...
            <button
              ...
              onClick={async () => {
                await modifyPlan("activatePlan", 0, "resume", plan);
            ...
            <button
              ...
              onClick={() => {
                router.push(
                  `/dashboard/merchant/plans/${plan.plan_id}/subscribers`,
                );
              }}
            >
              View Subscribers
